...
export function DashboardHeader({ user, compact }: DashboardHeaderProps) {
  ...
  const navItems = [
    { icon: Home, label: 'Dashboard', href: '/lost-and-found/dashboard' },
    { icon: ClipboardList, label: 'Claims', href: '/lost-and-found/claims' },
    { icon: Shield, label: 'Notes', href: '/lost-and-found/notes' },
    { icon: MapPin, label: 'Activity', href: '/lost-and-found/activity' },
    { icon: BarChart3, label: 'Archives', href: '/lost-and-found/archives' },
  ];
