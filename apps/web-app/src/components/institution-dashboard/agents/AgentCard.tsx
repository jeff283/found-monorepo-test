// src/components/institution-dashboard/agents/AgentCard.tsx
"use client";
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between text-sm">
        <div>
          <p className="caption text-muted-foreground mb-1">Agent location</p>
          <p className="body-1">{location}</p>
        </div>
        <div>
          <p className="caption text-muted-foreground mb-1">Found items</p>
          <p className="body-1">{foundItems}</p>
        </div>
      </div>
    </Card>
  );
